...
class AbstractSearcher:
    ...
    def load_data(self):
        ...
        self._training_data = self._df["Body"].values
    ...
    def load_models(self, device="cpu"):
        ...
        self._faiss_model = SentenceTransformer(self.EMBED_MODEL_PATH, device=device)
    ...
    def query_data(self, query):
        ...
        distances, indices = self._index.search(np.array(query_embedding, dtype=np.float32), k=len(bm25_results))
